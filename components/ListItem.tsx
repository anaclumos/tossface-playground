...
const ListItem = ({ title, url, text }: Props) => {
  return (
    ...
    >
      <div
        className='items-center h-full p-2 py-2 mx-auto transition-colors rounded-lg active:bg-slate-200 bg-slate-100 dark:bg-slate-700 dark:active:bg-slate-800'
      >
        <h3>{title}</h3>
