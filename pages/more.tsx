  ...
  return (
    <>
      ...
      <p className='py-1 text-base font-medium text-slate-900 dark:text-white' lang='ko'>
        ...
        의도적으로 변화된 이모지 디자인을 포함하고 있었습니다. 일본의 특정 문화를 나타내는 이모지를, 대응되는 한국의
        문화로 변경하거나, 과거의 기술을 나타내는 이모지를 대응되는 현대의 기술로 변경하는 것이 그 예시였습니다. 하지만
        안타깝게도 이런 변화는 여러 이해 관계자들의 반발을 일으켰고, 비바 리퍼블리카는 이모지를 제거해야 했습니다. 저는
        이 이모지들을 Unicode Private Area라고 하는 표준 기술을 활용하여 반환하는 것을 제안하였고, 비바 리퍼블리카는 이
        요청을 수락했습니다. 그러나 이 이모지들은 Unicode 표준에 없기에 쉽게 입력할 수 있는 방법이 없었습니다. 저는 이
        찾기 어려운 한국적, 시대적 가치를 담은 이모지들을 쉽게 복사할 수 있도록 이 웹페이지를 제작했습니다. 무엇보다 이
        웹사이트는 한국의 문화를 알리는 예쁜 박물관의 역할도 합니다.
      </p>
